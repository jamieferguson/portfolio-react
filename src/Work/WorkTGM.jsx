					...
					<div className="work-container">
						...
						<section className="example grid">
							...
							<p>
								...
								incidents as well as learn more by pressing each 'square'. Rather than try to present the data with any bias we created a way for users to tell us what they thought was the most important. To do this
								they could 'flag' an incident, which would increase the brightness of that incident on the grid.
							</p>
						</section>
						<section className="example grid">
