...
function WorkViator() {
	return (
		<BodyClassName className="work viator">
			<div className="work-container">
				...
				<section id="intro">
					<p>
						Viator is the market leader when it comes to booking tours & activities when travelling. I was hired as UX lead for their mobile products - Web, iOS and Android. As their product team is based on the other side
						of the planet (San Francisco) it was as much a logistical challenge as a design one.
					</p>
					<p>
