...
const WorkShorthand = () => (
	<BodyClassName className="work shorthand">
		<div className="work-container">
			...
			<section id="intro">
				...
				<p>
					In my role as 'Project Designer' I was design lead for all client projects. I would be involved from initial pitch stage, then developing the 'theme' as well as wireframing and designing any custom features as
					required.
				</p>
