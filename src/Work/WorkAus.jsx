        ...
        <div className="work aus">
          ...
          <div className="work-container">
            ...
            <section id="intro">
              ...
              <p>
                This included the usual day-to-day work of designing templates
                and standard editorial features, as well as larger project-based
                features.
              </p>
              <p>
            ...
            <section className="example grid">
              ...
              <p>
                'Your School' was the first project of it's kind in Australia
                that took all the available NAPLAN data and made it easy to rank
                and compare schools. Unfortunately this tool is no longer live.
              </p>
            </section>
            <section className="example grid">
              ...
              <p>
                With politics being at the core of The Australian's remit,
                federal elections are one of the most important events that they
                cover. I was in charge of designing the election tools for the
                site homepage.
              </p>
            </section>
            <section className="example grid">
              ...
              <p>
                The main feature we built for the election was an app that
                allowed you to view live election data for any seat in the
                country.
              </p>
            </section>
          </div>
